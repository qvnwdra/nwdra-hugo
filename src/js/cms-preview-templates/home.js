        ...
        <div className="bg-off-white pv4">
          <div className="ph3 mw7 center">
            ...
            <div className="flex-ns mhn2-ns mb3">
              {(entry.getIn(["data", "information"]) || []).map((info, i) => <div className="ph2-ns w-50-ns" key={i}>
                <img src={getAsset(info.get("image"))} alt="" className="center db mb3" style={{width: "240px"}}/>
                <p>{info.get("text")}</p>
              </div>)}
            </div>

            <div className="tc">
              <a href="#" className="btn raise">See all information</a>
            </div>
          </div>
        </div>
          ...
          <div className="ph3 mw7 center">
            ...
            <div className="flex-l mhn2-l">
              <div className="w-40-l ph2-l">
                <h2 className="f2 b lh-title mb2">{entry.getIn(["data", "issues", "heading"])}</h2>

                <p>{entry.getIn(["data", "issues", "text"])}</p>
              </div>
